            ...
            if ($cart_data['cart_template'] == 1) {
                ...
                foreach ($detail as $products) {
                    ...
                    $row .= '<img alt="Product Image" src="' . $img_path . '"
                        style="background:#0c528b;color:#ffffff;font-size:9px;max-height:200px;width:100%;;" class="CToWUd">';
                    $row .= '</a></td>';
                ...
                foreach ($detail as $products) {
                    ...
                    $cart_html .= "<li style='float:left;margin:5px;'>
                        ...
                        <a href='" . $action_url . "'><img style='width:200px' src='" . $img_path . "' style='width:100%;'></a></div>";
                ...
                foreach ($detail as $products) {
                    ...
                    $cart_html .= "<div style='display:inline-block;float:left;width:30%;'>
                        <a href='" . $action_url . "'>
                        <img  style='border:1px solid rgba(95, 158, 160, 0.66);width:100%;'
                        src='" . $img_path . "'></a></div>";
                ...
                foreach ($detail as $products) {
                    ...
                    $cart_html .= "<div style='width: 20%;padding: 2%;text-align: center;float:left;'>
                        <a href='" . $action_url . "'>
                        <img style='border: 1px solid rgba(255, 140, 10, 0.28);
                        width:100%' src='" . $img_path . "'></a></div>";
                ...
                foreach ($detail as $products) {
                    ...
                    $cart_html .= "<div style='width:30%;float:left;'><a href='"
                        . $action_url . "'><img  width='100' src='" . $img_path . "' style='width:100%;'></a></div>";
