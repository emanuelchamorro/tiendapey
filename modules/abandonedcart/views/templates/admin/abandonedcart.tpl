    ...
    <div class="box">
        <div class="navbar main hidden-print" >
            ...
            <table class="topbuttons" style="width: 400px; border-spacing: 10px; border-collapse: separate; margin-top: -12px;">
                <tr>
                    <td>
                        <a style="text-decoration: none;" href="{$front_cron_url}cron=update_carts&secure_key={$secure_key}" target="_blank">
                    ...
                    <td>
                        <a style="text-decoration: none;" onclick='if (!confirm("{l s='Do you want to Run Cron Manually?' mod='abandonedcart'}"))
                                    return false;' href="{$front_cron_url}cron=send_mails&secure_key={$secure_key}" target="_blank">
                            ...
                            <div class="slimScrollDiv">
                                <div class="slim-scroll">
                                    <ul>
                                        ...
                                        <li class=""><a class="glyphicons bookmark" target="_blank" href="https://addons.prestashop.com/en/149_knowband"><i></i><span>{l s='Other Plugins' mod='abandonedcart'}</span></a></li>
                                    </ul>
                                                            ...
                                                            <div class="widget" id="cron_instructions" data-toggle="collapse-widget" style="margin: 15px 8px 0px 0px;{if $velsof_abandoncart['schedule'] eq 0} display:none;{/if} ">
                                                                ...
                                                                <div class="widget-body" style="padding: 10px;">
                                                                    <p style="color:#A7A7A7; font-size: 13px; font-weight:normal;">
                                                                        ...
                                                                        {$front_cron_url}cron=send_mails&secure_key={$secure_key}
                                                                        <br /><br />
