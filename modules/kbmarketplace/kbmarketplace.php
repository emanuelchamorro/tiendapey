...
//        $this->unInstallMarketPlaceTabs();
//        $this->installMarketPlaceTabs();
//        $module_id = $this->getModuleIdByName($this->name);
//       $shop_id = $this->context->shop->id;
//       $data = Db::getInstance()->execute('INSERT INTO '._DB_PREFIX_.'module_shop set id_module='.(int) $module_id .',id_shop='.(int) $shop_id);
        $html = null;
