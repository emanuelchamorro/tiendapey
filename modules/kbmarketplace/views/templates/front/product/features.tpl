           ...
           <div class="kb-block kb-form">
            ...
            <ul class="kb-form-list">
                ...
                <li class="kb-form-r">
                    ...
                    <div class="kb-form-field-block">
                        <input type="text" class="kb-inpfield" id="kb-product-{$feature['id_feature']|intval}-feature" name="feature_{$feature['id_feature']|intval}_cvalue" value="{if isset($product_features[$feature['id_feature']])}{$product_features[$feature['id_feature']]}{/if}">
                    </div>
                </li>
                {/if}
                {* changes over *}
