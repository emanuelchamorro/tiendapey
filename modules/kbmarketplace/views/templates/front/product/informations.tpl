<div class="kb-panel outer-border kb_product_section">
    ...
    <div class='kb-panel-header kb-panel-header-tab'>-->
    <div class='kb-panel-header-tab'>
        <!--<h1>{$form_title|escape:'htmlall':'UTF-8'}</h1>-->
        <h3>Completá la ficha técnica</h3>
        <p>Tendrás mejor ubicación en los resultados de búsqueda<br/>y tus compradores tendrán toda la información que necesitan para elegirte.</p>
            ...
            <ul class="kb-form-list">
                <li class="kb-form-l">
                    <div class="kb-form-label-block">
                        ...
                        <h4 class="kblabel ">Escribí el título de tu publicación</h4>
                        <p>Indicá producto, marca y modelo para que los compradores sepan qué vendés.</p>
                        <p>&nbsp;</p>
                    </div>
                    <div class="kb-form-field-block">
                        <input placeholder="Ej: Celular Samsung Galaxy S9 64 GB negro" type="text" class="kb-inpfield required" validate="isGenericName" name="name_{$default_lang|intval}" lang-id="{$default_lang|intval}" value="{$name|escape:'htmlall':'UTF-8'}" onkeyup="updateLinkRewrite(this)" />
                    </div>
                </li>
                <li class="kb-form-r">
                    <div class="kb-form-label-block">
                ...
                <li class="kb-form-l">
                    ...
                    <div class="kb-form-field-block">
                        <input type="hidden" class="kb-inpfield" name="ean13" value="{$ean13|escape:'htmlall':'UTF-8'}" maxlength="13"/>
                    </div>
                </li>
                <li class="kb-form-r">
                    <div class="kb-form-label-block">
                    ...
                    <div class="kb-form-field-block">
                        <input type="hidden" class="kb-inpfield" name="upc" value="{$upc|escape:'htmlall':'UTF-8'}" maxlength="12" />
                    </div>
                </li>
                <li class="kb-form-l">
                    <div class="kb-form-label-block">
                    ...
                    <div class="kb-form-field-block">
                        <select name="condition" class="kb-inpselect form-control form-control-lg" multiple>
                ...
                <li class="kb-form-r">
                    ...
                    <div class="kb-form-field-block">
                        <select name="id_manufacturer" class="kb-inpselect form-control form-control-lg" multiple>
                ...
                <li class="kb-form-l">
                    <div class="kb-form-label-block">
                        <span class="kblabel ">{l s='Estado de la publicación' mod='kbmarketplace'}</span>
                    </div>
                    <div class="kb-form-field-block">
                        <select name="active" class="kb-inpselect form-control form-control-lg" multiple>
                            {if !empty($seller_product)}
                                <option value="1" {if $active eq 1}selected="selected"{/if}>{l s='Activa' mod='kbmarketplace'}</option>
								<option value="0" {if $active eq 0}selected="selected"{/if}> {l s='Pausada' mod='kbmarketplace'}</option>
                            {else}
                                <option value="0" {if $active eq 0}selected="selected"{/if}>{l s='Pausada' mod='kbmarketplace'}</option>
                                <option value="1" {if $active eq 1}selected="selected"{/if}>{l s='Activa' mod='kbmarketplace'}</option>
                            {/if}
                ...
                <li class="kb-form-r">
                    <div class="kb-form-label-block">
                        <span class="kblabel ">{l s='Visibilidad de la publicación' mod='kbmarketplace'}</span>
                    </div>
                    <div class="kb-form-field-block">
                        <select name="visibility" class="kb-inpselect form-control form-control-lg" multiple>
