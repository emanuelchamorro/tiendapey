            ...
            <ul class="kb-form-list">
                <li class="kb-form-fwidth">
                    <div class="kb-form-label-inblock">
                        <p><span class="kblabel "><i class="kb-material-icons" data-toggle="tooltip" data-placement="top" title="{l s='Start by typing the first letters of the product name, then select the product from the drop-down list.' mod='kbmarketplace'}">&#xE88F;</i>{l s='Add Product in your Pack' mod='kbmarketplace'}</span></p>
                    </div>
