    ...
    <div id="kb-product-form-price" class='kb-panel-body'>
        <div class="kb-block kb-form">
            <ul class="kb-form-list">
                ...
                <li class="kb-form-l">
                    <div class="kb-form-label-block">
                        <span class="kblabel ">Precio de venta</span>
                    </div>
                    <div class="kb-form-field-block">
                        <div class="kb-labeled-inpfield">
                            {if isset($currency_prefix)}
                ...
                <li class="kb-form-r d-none" {*style="padding-left: 35px;width: 410px;"*}>
                    <div class="kb-form-label-block">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-xs-12">
                             {if isset($currency_suffix)}
                                <span class="inplbl">{$currency_suffix|escape:'htmlall':'UTF-8'}</span>
                            {/if}
                                <select class="kb-inpselect" id="discount_type" name="discount_type" onchange="setrequiredvalidation()">
                ...
                <li class="kb-form-l col-sm-6 col-xs-12">
                    <div class="kb-form-label-block">
                ...
                <li class="kb-form-r col-sm-6 col-xs-12">
                    <div class="kb-form-label-block">
                ...
                <li class="kb-form-fwidth last-row">
                    <div class="kb-form-field-block">
                        <div class="kboption-inline kb-inpoption d-none">
