...
<div class="kb-panel outer-border kb_product_section">
    ...
    <div class='kb-panel-header-tab'>
        ...
        <h3>{$form_title|escape:'htmlall':'UTF-8'}</h3>
            ...
            <ul class="kb-form-list">
                <li class="kb-form-l">
                    <div class="kb-form-label-block">
                        ...
                        <span class="kblabel ">¿Cuantas unidades tenes disponibles?</span>
                    </div>
                ...
                <li class="kb-form-r">
                    <div class="kb-form-label-block">   
                        <span class="kblabel ">{l s='Action when product is out of stock' mod='kbmarketplace'}</span>
                    </div>
                    <div class="kb-form-field-block">
                        <select name="out_of_stock" class="kb-inpselect" multiple>
                            ...
                            {*<option value="2" {if $out_of_stock == 2} selected="selected" {/if}>{if $order_out_of_stock == 1}{l s='Allow orders' mod='kbmarketplace'}{else}{l s='Deny orders' mod='kbmarketplace'}{/if}</option>*}
                        </select>
                    </div>
                </li>
                <li class="kb-form-l d-none">
                     <div class="kb-form-label-block">
                        <span class="kblabel ">Stock</span>
                    </div>
                    <div class="kb-form-label-block">
