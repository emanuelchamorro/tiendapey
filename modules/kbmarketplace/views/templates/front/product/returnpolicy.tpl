                ...
                <table class="kb-table-list">
                    <thead>
                        <tr class="heading-row">
                            ...
                            <th>{l s='Credit(in days)' mod='kbmarketplace'}</th>
                            <th>{l s='Refund (in days)' mod='kbmarketplace'}</th>
                            <th>{l s='Replacement (in days)' mod='kbmarketplace'}</th>
                        </tr>
                    </thead>
                    <tbody id="kb_return_policy_list">
                        {if count($policy) == 0}
                            <tr><td colspan="4" class="kb-empty-table kb-tcenter">{l s='No Policy has been added till now.' mod='kbmarketplace'}</td></tr>
                        {/if}
                    </tbody>
                </table>
                        ...
                        <div class="kb-form-field-block kb-mbtm10">
                            ...
                            <div class="form-field-indis cobmination-field">
                                <div class='span4'>
                                    ...
                                    <input class="rm_policy_options_day_input" id="credit" type="text" disabled="disabled" name="credit"/> &nbsp;({l s='in days' mod='kbmarketplace'})
                                </div>
                                <div id="rm_credit_box" class="span4 rm_policy_options_text" style='display:none;'>
                                    {$i = 0}
                                    {foreach from=$languages item='lang'}
                                        <div class='span0'><img src="{$img_lang_dir|escape:'quotes':'UTF-8'}{$lang['id_lang']|escape:'htmlall':'UTF-8'}.jpg" height="11px" width="16px" alt="{$lang['name']|escape:'htmlall':'UTF-8'}" title="{$lang['name']|escape:'htmlall':'UTF-8'}"/></div>
                        ...
                        <div class="kb-form-field-block kb-mbtm10">
                            ...
                            <div class="form-field-indis cobmination-field">
                                <div class='span4'>
                                    ...
                                    <input class="rm_policy_options_day_input" id="Refund" type="text" disabled="disabled" name="refund" /> &nbsp;({l s='in days' mod='kbmarketplace'})
                                </div>
                                <div id="rm_refund_box" class="span4 rm_policy_options_text" style='display:none;'>
                                    {$i = 0}
                                    {foreach from=$languages item='lang'}
                                        <div class='span0'><img src="{$img_lang_dir|escape:'quotes':'UTF-8'}{$lang['id_lang']|escape:'htmlall':'UTF-8'}.jpg" height="11px" width="16px" alt="{$lang['name']|escape:'htmlall':'UTF-8'}" title="{$lang['name']|escape:'htmlall':'UTF-8'}"/></div>
                        ...
                        <div class="kb-form-field-block kb-mbtm10">
                            ...
                            <div class="form-field-indis cobmination-field">
                                <div class='span4'>
                                    ...
                                    <input class="rm_policy_options_day_input" id="Replacement" type="text" disabled="disabled" name="replacement"/> &nbsp;({l s='in days' mod='kbmarketplace'})
                                </div>
                                    <div id="rm_replacement_box" class="span4 rm_policy_options_text" style='display:none;'>
                                    {$i = 0}
                                    {foreach from=$languages item='lang'}
                                        <div class='span0'><img src="{$img_lang_dir|escape:'quotes':'UTF-8'}{$lang['id_lang']|escape:'htmlall':'UTF-8'}.jpg" height="11px" width="16px" alt="{$lang['name']|escape:'htmlall':'UTF-8'}" title="{$lang['name']|escape:'htmlall':'UTF-8'}"/></div>
...
<script>
    var number_days_error = "{l s='Please enter days between 0 to 1000.' mod='kbmarketplace'}";
    ...
    var credit_error = "{l s='Please enter days at Credit.' mod='kbmarketplace'}";
    var refund_error = "{l s='Please enter days at Refund.' mod='kbmarketplace'}";
    var replacement_error = "{l s='Please enter days at Replacement.' mod='kbmarketplace'}";
