        ...
        <div class="kb-block kb-form">
            ...
            <ul class="kb-form-list">
                ...
                <li class="kb-form-fwidth last-row">
                    ...
                    <div class="kb-form-field-block">
                        {*elimine class del input: "required"*}
                        <input type="text" class="kb-inpfield" validate="isLinkRewrite" name="link_rewrite_{$default_lang|intval}" value="{$link_rewrite|htmlentitiesUTF8|default:''}"  autocomplete="off" onkeyup="$('#friendly-url-demo').html(str2url($(this).val()));"/>
                    </div>
