<div class="kb-block seller_profile_view">
    ...
    <div class="info-view">
        ...
        <div class="seller-info">
            <div class="seller-basic">
                <div class="seller-name">
                    ...
                    <div class="kbmp-_block reputacion" style="position:relative;">
                        <a href="{$link->getModuleLink($kb_module_name, 'sellerfront', ['render_type' => 'sellerreviews', 'id_seller' => $seller['id_seller']], (bool)Configuration::get('PS_SSL_ENABLED'))|escape:'htmlall':'UTF-8'}" title="{$seller['seller_review_count']|escape:'htmlall':'UTF-8'}">
                            <div class="vss_seller_ratings">
                                ...
                                <div class="vss_rating_filled" style="display:inline-block;vertical-align:middle;width:{$seller['seller_rating']|escape:'htmlall':'UTF-8'}%"> ★★★★★</div>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="kbmp-_block rating-comentarios">
                    {* changes by rishabh jain for seller shortlisting link *}
                        ...
                        <div class="seller-rating-block">
                            <div class="kbmp-_inner_block" style="position:relative;">
                                <div class="vss_seller_ratings">
                                    <!-- Do not customise it -->
                                    <a href="javascript:addShortListSeller(this, {$seller['id_seller']});" class="sfl_product_link_{$seller['id_seller']}" style="padding-left:7px;font-size:13px;color: #2fb5d2;"><i class="kb-material-icons shortlist_link" style="{if isset($is_already_added) && $is_already_added == 1}color: #2ec2e7;{else}color:#2ec2e7;{/if}">&#xe87d;</i>{if isset($is_already_added) && $is_already_added == 1}{l s='Favourite Seller' mod='kbmarketplace'}{else}{l s='Mark Seller as Favourite' mod='kbmarketplace'}{/if}</a>
                                    <!-- Set only width in percentage according to rating -->
                                </div>
                            </div>
                        </div>
        ...
        <div class="dataSeller">
            <span class="location"><i class="locationPin"></i>{$seller['address']}, {$seller['state']}, {$seller['country']}</span>
        </div><!-- data seller-->
        </div><!-- seller-info -->
        {if $gdpr_enabled}
