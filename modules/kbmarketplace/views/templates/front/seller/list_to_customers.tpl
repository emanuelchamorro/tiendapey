...
{if isset($sellers) && count($sellers) > 0}
    <div class="container">
        ...
        {if isset($kb_pagination.pagination) && $kb_pagination.pagination neq ''}
            <div id="front-end-customer-pagination" class="container top-pagination-content clearfix">
    ...
    <div id="seller_list_to_customers" class="container">
...
<div class="container">
    <h1 class="page-heading" style='border:0;'>
        ...
        <span clas="cat-name">Aún no tienes vendedores favoritos</span>
        <div class="clearfix"></div>
    </h1>
        <p><a href="{$urls.base_url}sellers">Explorar vendedores</a></p>
    <div class="clearfix"></div>
</div>
{/if}
<script>
