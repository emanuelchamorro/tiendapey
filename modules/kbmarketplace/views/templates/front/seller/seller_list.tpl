                    ...
                    <div class="thumbnail-container">
                        ...
                        <div class="product-description">
                            ...
                            {* <div class="product-price-and-shipping">
                                <div class="kbmp-_row kb-tcenter">
                                <div class="kbmp-_inner_block">
                                    <a href="{$seller.view_review_href nofilter}" class="vss_active_link vss_read_review_bck" title='{l s='%s Review(s)'|sprintf:$seller.total_review mod='kbmarketplace'}'>
                                        <span class="">{l s='View Reviews' mod='kbmarketplace'}</span>
                                    </a>
                                </div>
                                    ...
                                    {if $seller.display_write_review}
                                        <div class="kbmp-_inner_block">
                                            {if !$kb_is_customer_logged}
                                                <a href="{$link->getPageLink('my-account', (bool)Configuration::get('PS_SSL_ENABLED')) nofilter}"  class="vss_active_link vss_write_review_bck"><span class="">{l s='Write Review' mod='kbmarketplace'}</span></a>
