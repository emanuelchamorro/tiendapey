<div>
    ...
    <div class="slr-f-box container">
        <div class="container ProductsProfile">
            <div class="row">
                <div class="col-sm-3">
                    <h3 class="s-p-filter">
                        Ordenar publicaciones
                    </h3>
                        <form action="{$filter_form_action}" method="get" id="seller_products_form">
                        <div class="filterSortGrid">
                            ...
                            <div class="sort-grid-or-list">
                                <ul>
                                    <li><i class="material-icons show_grid active"></i></li>
                                    <li><i class="material-icons show_list"></i></li>
                                </ul>
                            </div>
                        </div>
                        <h3 class="s-p-filter">
                            ...
                            {if isset($category_list) && count($category_list) > 0}
                                <select name="s_filter_category" id="s_filter_category" onchange="$('#seller_product_pagination_var').val(0);$('#seller_products_form').submit();">
