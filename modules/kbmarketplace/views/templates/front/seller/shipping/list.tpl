<div class="kb-content">
    <div class="kb-content-header">
        ...
        <div class="kb-content-header-btn">
            <a href="{$new_shipping_link nofilter}" class="btn-sm btn-success" title="{l s='click to add new shipping' mod='kbmarketplace'}"><i class="kb-material-icons">add</i>{l s='Add New' mod='kbmarketplace'}</a>
