...
class AdminKbPushSettingsController extends AdminKbPushCoreController
{
    public function __construct()
    {
        parent::__construct();

        $this->toolbar_title = $this->module->l('Knowband Push Notification Configurations', 'AdminKbPushSettingsController');
    }
