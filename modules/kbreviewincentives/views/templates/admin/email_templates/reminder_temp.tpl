							...
							<tbody>
								<tr>
									...
									<table align="center" bgcolor="#00d0c0" border="0" cellpadding="0" cellspacing="0" class="mlContentTable" style="background: #00d0c0; width: 640px;" width="640">
										<tbody>
											<tr>
												<td align="center" class="mlContentContainer mlContentImage mlContentHeight" style="padding: 0px 50px 10px 50px;"><img border="0" class="mlContentImage" height="99" src="{reminder_icon_path}" style="display: block;max-width: 99px;" width="99" /></td>
											</tr>
										</tbody>
									</table>
									</td>
									...
									<table align="center" bgcolor="#00d0c0" border="0" cellpadding="0" cellspacing="0" class="mlContentTable" style="background: #00d0c0; width: 640px;" width="640">
										<tbody>
											<tr>
												...
												<p style="margin: 0px 0px 10px 0px;        line-height: 25px;text-align: center;"><strong>Share your thoughts on your recent {shop_name} purchase(s) and get alluring discounts in return.</strong></p>
												</td>
											</tr>
										</tbody>
									</table>
									...
									<table align="center" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" class="mlContentTable" style="background: #FFFFFF; width: 640px;" width="640">
										<tbody>
											<tr>
												...
												<p style="margin: 0px 0px 10px 0px; line-height: 23px;">How did the recent purchases meet your expectation? We would love to have your feedback.</p>
												</td>
											</tr>
										</tbody>
									</table>
								...
								<tr>
									...
									<table align="center" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" class="mlContentTable" style="background: #FFFFFF; width: 640px;" width="640">
										<tbody>
											<tr>
												<td align="left" class="mlContentContainer" style="padding: 15px 50px 5px 50px; font-family: Helvetica; font-size: 14px; color: #7F8C8D; line-height: 23px;">
												<p style="margin: 0px 0px 10px 0px; line-height: 23px;">Please feel free to email us with any questions.</p>

												<p style="margin: 0px 0px 10px 0px; line-height: 23px;">Best regards<br />
												<br />
                                                                                                {shop_url}<br />
												Support Email: {shop_email}</p>
												</td>
											</tr>
										</tbody>
									</table>
