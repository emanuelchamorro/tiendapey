							...
							<tbody>
								<tr>
									...
									<table align="center" bgcolor="#00d0c0" border="0" cellpadding="0" cellspacing="0" class="mlContentTable" style="background: #00d0c0; width: 640px;" width="640">
										<tbody>
											<tr>
                                                                                            <td align="center" class="mlContentContainer mlContentImage mlContentHeight" style="padding: 0px 50px 10px 50px;"><h1>{shop_name}</h1></td>
											</tr>
										</tbody>
									</table>
									</td>
							...
							<tbody>
								<tr>
									...
									<table align="center" bgcolor="#00d0c0" border="0" cellpadding="0" cellspacing="0" class="mlContentTable" style="background: #00d0c0; width: 640px;" width="640">
										<tbody>
											<tr>
                                                                                            <td align="center" class="mlContentContainer mlContentImage mlContentHeight" style="padding: 0px 50px 10px 50px;"><img border="0" class="mlContentImage" height="99" src="{disapprove_icon_path}" style="display: block;max-width: 99px;" width="99" /></td>
											</tr>
										</tbody>
									</table>
									</td>
									...
									<table align="center" bgcolor="#00d0c0" border="0" cellpadding="0" cellspacing="0" class="mlContentTable" style="background: #00d0c0; width: 640px;" width="640">
										<tbody>
											<tr>
												...
												<p style="margin: 0px 0px 10px 0px;        line-height: 25px;text-align: center;"><strong>Sorry! Your review has been disapproved.</strong></p>
												</td>
											</tr>
										</tbody>
									</table>
									...
									<table align="center" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" class="mlContentTable" style="background: #FFFFFF; width: 640px;" width="640">
										<tbody>
											<tr>
												...
												<h2 style="line-height: 26px; text-decoration: none; font-weight: bold; margin: 0px 0px 10px 0px;font-family: Helvetica; font-weight: bold; font-size: 20px; color: #000000; text-align: left;">Dear {customer_name},</h2>

												<p style="margin: 0px 0px 10px 0px; line-height: 23px;">We really appreciate all the trouble taken by you to posting your reviews. However, it was disapproved. We apologize for the same.</p>
												</td>
											</tr>
										</tbody>
									</table>
								...
								<tr>
									...
									<table align="center" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" class="mlContentTable" style="background: #FFFFFF; width: 640px;" width="640">
										<tbody>
											<tr>
												<td align="left" class="mlContentContainer" style="padding: 15px 50px 5px 50px; font-family: Helvetica; font-size: 14px; color: #7F8C8D; line-height: 23px;">
												<p style="margin: 0px 0px 10px 0px; line-height: 23px;">Please do let us know if there’s anything else that we can do for you.</p>

												<p style="margin: 0px 0px 10px 0px; line-height: 23px;">Thank You!!<br />
												<br />
												{shop_url}<br />
                                                                                                Support Email:- {shop_email}<br />
												</td>
											</tr>
										</tbody>
									</table>
