									...
									<table align="center" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" class="mlContentTable" style="background: #FFFFFF; width: 640px;" width="640">
										<tbody>
											<tr>
												...
												<p style="margin: 0px 0px 10px 0px; line-height: 23px;">We would like to thank you for the impressive product review you shared about our product {product_name}. Your review has been approved . To check the same click here {review_link}.

As a token of appreciation for your valuable feedback, we are offering you a discount coupon of {amount}. You an avail the offer on any purchase with the Coupon Code {coupon_code}. 
</p>
												</td>
											</tr>
										</tbody>
