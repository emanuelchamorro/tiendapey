							...
							<tbody>
								<tr>
									...
									<table align="center" bgcolor="#00d0c0" border="0" cellpadding="0" cellspacing="0" class="mlContentTable" style="background: #00d0c0; width: 640px;" width="640">
										<tbody>
											<tr>
												<td align="center" class="mlContentContainer mlContentImage mlContentHeight" style="padding: 0px 50px 10px 50px;"><img border="0" class="mlContentImage" height="99" src="{approve_icon_path}" style="display: block;max-width: 99px;" width="99" /></td>
											</tr>
										</tbody>
									</table>
									</td>
									...
									<table align="center" bgcolor="#00d0c0" border="0" cellpadding="0" cellspacing="0" class="mlContentTable" style="background: #00d0c0; width: 640px;" width="640">
										<tbody>
											<tr>
												...
												<p style="margin: 0px 0px 10px 0px;        line-height: 25px;text-align: center;"><strong>Congratulations !! You review has been approved.</strong></p>
												</td>
											</tr>
										</tbody>
									</table>
										...
										<tbody>
											<tr>
												...
												<h2 style="line-height: 26px; text-decoration: none; font-weight: bold; margin: 0px 0px 10px 0px;font-family: Helvetica; font-weight: bold; font-size: 20px; color: #000000; text-align: left;">Dear {customer_name},</h2>
                                                                                                ...
                                                                                                <p style="margin: 0px 0px 10px 0px; line-height: 23px;">Thanks for being a valued customer of {shop_name}! We truly appreciate your heart-warming review on {product_name}.</p><br>
                                                                                                <p style="margin: 0px 0px 0px 0px; line-height: 5px;"> You can check your review on following link:</p><br>
                                                                                                <h4>{product_link}</h4>
												</td>
											</tr>
										</tbody>
